...
import PrescriptionTemplate from './Components/Patent/PrescriptionTemplate/PrescriptionTemplate';
        ...
        <AuthSyncWrapper>
          <Routes>
            ...
            <Route path="/medicine-list" element={<PrivateRoute><MedicineList/></PrivateRoute>} />
              ...
              <Route path="/download-prescription" element={<PrescriptionTemplate />} />
            </Route>
          </Routes>
