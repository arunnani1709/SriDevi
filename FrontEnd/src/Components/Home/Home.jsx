      ...
      <div className="flex flex-1 min-h-screen relative">
        {!sidebarOpen && (
          <button
            ...
            className="absolute top-5 left-0 z-30 bg-green-600 text-white px-3 py-1 rounded-r-md shadow hover:bg-green-700 transition"
          >
            Menu
          </button>
        )}
        ...
        {sidebarOpen && (
          <div className="w-72 bg-white shadow-md transition-all duration-300 flex-shrink-0 z-20">
          ...
          <div className="flex-1 px-6 py-10">
            ...
            <div className="mt-12">
              ...
              <div className="w-full flex justify-center overflow-hidden">
                <div className="w-[90%] max-w-6xl overflow-hidden">
